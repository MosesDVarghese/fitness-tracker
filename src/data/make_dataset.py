...
# apply resampling rule for each day, drop nulls
data_resampled = pd.concat([df.resample(rule="200ms").apply(sampling).dropna() for df in days])

data_resampled.info()

# convert to int since .0 is not needed (eg. 64.0, 71.0)
...
# convert to pickle file since this is intermediate step and 
# they are smaller in size and faster to load
